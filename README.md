...
dependencies {
    implementation "com.github.lhotari:reactive-pulsar-adapter:0.0.5"
}
```
...
dependencies {
    implementation "com.github.lhotari:reactive-pulsar-spring-boot-starter:0.0.5"
    testImplementation "com.github.lhotari:reactive-pulsar-spring-test-support:0.0.5"
}
```
...
dependencies {
    implementation "com.github.lhotari:reactive-pulsar-adapter:0.0.5"
    implementation "com.github.lhotari:reactive-pulsar-caffeine-producer-cache:0.0.5"
}
```
